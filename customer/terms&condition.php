  ...
  <div class="terms">
    ...
    <div class="terms-condition">
      <p>
        ...
        the CleckFreshMart. The use of the Internet pages of the CleckFreshMart
      ...
      <p>
        ...
        CleckFreshMart. By means of this data protection declaration, our
      ...
      <p>
        As the controller, the CleckFreshMart has implemented numerous technical
      ...
      <ol type="1">
        <li>
          <h3>Definations</h3>
          <p>
            The data protection declaration of the Company Name is based on the
        ...
        <li>
          ...
          <p>
            ...
            protection is:
            <br />Company Name <br />Company Address <br />300057 London
            <br />United Kingdom <br />Phone: +1234324543 <br />Email:
            email@company.com <br />Website: https://www.example.com
          </p>
        </li>
        <li>
          <h3>Cookies</h3>
          <p>
            The Internet pages of the Company Name use cookies. Cookies are text
        ...
        <li>
          ...
          <p>
            The website of the Company Name collects a series of general data
          ...
          <p>
            Therefore, the Company Name analyzes anonymously collected data and
        ...
        <li>
          <h3>Subscription to our newsletters</h3>
          <p>
            On the website of the Company Name, users are given the opportunity
            ...
            as when the newsletter is ordered from the controller. Company Name
            informs its customers and business partners regularly by means of a
            newsletter about enterprise offers. The enterprise’s newsletter may
        ...
        <li>
          ...
          <p>
            The newsletter of the Company Name contains so-called tracking
            ...
            tracking pixel, the Company Name may see if and when an e-mail was
            opened by a data subject, and which links in the e-mail were called
            up by data subjects. Such personal data collected in the tracking
            pixels contained in the newsletters are stored and analyzed by the
            controller in order to optimize the shipping of the newsletter, as
            well as to adapt the content of future newsletters even better to
            the interests of the data subject. These personal data will not be
            passed on to third parties. Data subjects are at any time entitled
            to revoke the respective separate declaration of consent issued by
            means of the double-opt-in procedure. After a revocation, these
            personal data will be deleted by the controller. The Company Name
        ...
        <li>
          ...
          <p>
            The website of the Company Name contains information that enables a
            ...
            this personal data to third parties. Routine erasure and blocking of
            personal data
          </p>
        </li>
        <li>
          <h3>Right of the data subject</h3>
          <p>
            Right of confirmation Each data subject shall have the right granted
            ...
            any employee of the controller. Right of access Each data subject
            ...
            the following information: the purposes of the processing; the
            categories of personal data concerned; the recipients or categories
            of recipients to whom the personal data have been or will be
            disclosed, in particular recipients in third countries or
            international organisations; where possible, the envisaged period
            for which the personal data will be stored, or, if not possible, the
            criteria used to determine that period; the existence of the right
        ...
        <li>
          ...
          <p>
            ...
            be passed on to a doctor, hospital or other third party.
          </p>
        </li>
        <li>
          <h3>
        ...
        <li>
          <h3>
            Provision of personal data as statutory or contractual reqirement
          </h3>
          <p>
        ...
        <li>
          <h3>Existence of automated descision-making</h3>
          <p>
            As a responsible company, we do not use automatic decision-making or
            profiling. This Privacy Policy has been generated by the Privacy
            Policy Generator of the External Data Protection Officers that was
