...
<body>
  ...
  <div class="profile-container">
    <header>
      ...
      echo "<a href='profile.php?cat=update&role=customer'><span class='material-symbols-outlined'>
          edit
        </span></a>";
      ...
      <div class="modal-content text-bg-secondary">
        ...
        <form method="post" action=''>
          ...
          <div class="modal-footer">
            ...
            <input class="verify-btn btn-secondary btn text-warning" type="submit" name="changepassword" value="Confirm  >>" />
          </div>
        </form>
      </div>
