    ...
    <form method="POST" enctype="multipart/form-data" action=''>
      ...
      <div class="product-part1">
        ...
        <div class="info2">
          ...
          <textarea name="description" class="inputbox " cols="30" rows="5" placeholder="Write description about products..."></textarea>
        </div>
      ...
      <div class="product-part2">
        ...
        <div class="info2">
          ...
          <input type="number" class="inputbox" name="productstock" placeholder="Product Stock" />
        </div>
      </div>
