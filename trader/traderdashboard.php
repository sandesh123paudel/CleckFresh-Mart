  ...
  <div class="offcanvas offcanvas-start" data-bs-scroll="true" data-bs-backdrop="false" tabindex="-1" id="offcanvasScrolling" aria-labelledby="offcanvasScrollingLabel">
    ...
    <div class="offcanvas-body">
      <div class="side-links">
        ...
        <!-- Product dropdown -->
        <div class="category-link">
          <div class="dropdown" onmouseover="onMouse('products')" onmouseout="outMouse('products')">
            <div class="dropdown-link">
              <span class="material-symbols-outlined">shopping_bag</span>
              <h4>PRODUCTS</h4>
            </div>
          ...
          <!-- list shops -->
          <div class="dropdown-content" id="products" onmouseover="onMouse('products')" onmouseout="outMouse('products')">
            <div>
              <a href="traderdashboard.php?cat=Productlist&name=Products">Products Lists</a>
              <a href="traderdashboard.php?cat=Addproduct&name=Products">Add Products</a>
            </div>
        ...
        <!-- dropdown for Shops -->
        <div class="category-link">
          <div class="dropdown" onmouseover="onMouse('shops')" onmouseout="outMouse('shops')">
            <div class="dropdown-link">
          ...
          <!-- list shops -->
          <div class="dropdown-content" id="shops" onmouseover="onMouse('shops')" onmouseout="outMouse('shops')">
            <div>
              <a href="traderdashboard.php?cat=Shoplist&name=Shops">Shops Lists</a>
              <a href="traderdashboard.php?cat=Addshop&name=Shops">Add Shops</a>
            </div>
        ...
        <!-- dropdown for orders -->
        <div class="category-link">
          <div class="dropdown" onmouseover="onMouse('orders')" onmouseout="outMouse('orders')">
            <div class="dropdown-link">
              <span class="material-symbols-outlined">redeem</span>
              <h4>ORDERS</h4>
            </div>
          ...
          <!-- list shops -->
          <div class="dropdown-content" id="orders" onmouseover="onMouse('orders')" onmouseout="outMouse('orders')">
            <div>
              <a href="traderdashboard.php?cat=Orderlist&name=Orders">Order Lists</a>
              <a href="traderdashboard.php?cat=Orderhistory&name=Orders">Order History</a>
            </div>
